                    ...
                    <div class="col-lg-6 col-lg-6 col-md-6 col-sm-12 col-12 layout-spacing"   style="margin: auto;">
                        <div class="statbox widget box box-shadow">
                            <div class="widget-header">                                
                                <div class="row">
                                    <div class="col-xl-12 col-md-12 col-sm-12 col-12">
                                       <center> <u><h4>Edit member</h4></u></center>
                                    </div>                                                      
                                </div>
                            </div>
                            <div class="widget-content widget-content-area">
                            <?php
                                        include 'db.php';
                                        $id = $_GET['pid'];
                                        $getpro= mysqli_query($conn,"SELECT * FROM members WHERE id= '$id' ");
                                    ...
                                    ?>
                                <form class="adcust" id="upmem">
                                   
                                   <div class="form-group mb-4">
                                       <!-- <label for="exampleFormControlInput1">Quantity</label> -->
                                       <input name="name" type="text" class="form-control-rounded form-control" id="exampleFormControlInput1" placeholder="Member's  Name" value="<?php echo $name;?>">
                                       <input name="id" type="hidden" class="form-control-rounded form-control" id="exampleFormControlInput1" placeholder="Member's  Name" value="<?php echo $id;?>">
                                   ...
                                   <div class="form-group mb-4">
                                       <!-- <label for="exampleFormControlInput1">Quantity</label> -->
                                       <input name="nickname" type="text" class="form-control-rounded form-control" id="exampleFormControlInput1" placeholder="NickName" value="<?php echo $nickname;?>">
                                   </div>

                                   <div class="form-group mb-4">
                                       <!-- <label for="exampleFormControlInput1">Quantity</label> -->
                                       <input name="position" type="text" class="form-control-rounded form-control" id="exampleFormControlInput1" placeholder="Position" value="<?php echo $position;?>">
                                   </div>
                                   ...
                                   <div class="form-group mb-4">
                                       <!-- <label for="exampleFormControlInput1">Quantity</label> -->
                                       <input name="contact" type="number" class="form-control-rounded form-control" id="exampleFormControlInput1" placeholder="Phone Number " value="<?php echo $contact;?>">
                                   </div>


                                   <div class="form-group mb-4">
                                       <!-- <label for="exampleFormControlInput1">Quantity</label> -->
                                       <input name="club" type="text" class="form-control-rounded form-control" id="exampleFormControlInput1" placeholder="Club/Society" value="<?php echo $club;?>">
                                   </div>

                                   <div class="form-group mb-4">
                                       <!-- <label for="exampleFormControlInput1">Quantity</label> -->
                                      <textarea name="ambition"  class="form-control-rounded form-control" id="exampleFormControlInput1" placeholder="Ambition"><?php echo $ambition;?></textarea>
                                   </div>
                                   ...
                                   <div class="row">
                                           <div class="col-md-6">
                                               ...
                                               <br/>
                                               <input type=button value="Take Snapshot" onClick="take_snapshot()" id="btntk">
                                           ...
                                           <div class="col-md-12 text-center">
                                               ...
                                               <input type=button value="activate" onClick="callcam()" id="calcu">
                                           </div>
                                   </div> -->
                                   ...
                                   <input type="submit" name="" class="mt-4 mb-4 btn btn-button-7 btn-rounded sub" value="Update member" style="margin-left:150px;background-color:green !important;">
                ...
                <div class="col-xl-5 col-md-6 col-sm-6 col-12">
                    <ul class="list-inline mb-0 d-flex justify-content-sm-end justify-content-center mr-sm-3 ml-sm-0 mx-3">
                        <li class="list-inline-item  mr-3">
                            <p class="bottom-footer">© <?php echo date("Y");?> <a target="_blank" href="#">Designed by Dollarsoft Corporation</a></p>
                        </li>
