                    ...
                    <div class="col-lg-6 col-lg-6 col-md-6 col-sm-12 col-12 layout-spacing"   style="margin: auto;">
                        <div class="statbox widget box box-shadow">
                            <div class="widget-header">                                
                                <div class="row">
                                    <div class="col-xl-12 col-md-12 col-sm-12 col-12">
                                       <center> <u><h4>Edit Admin</h4></u></center>
                                    </div>                                                      
                                </div>
                            </div>
                            <div class="widget-content widget-content-area">
                            <?php
                                        include 'db.php';
                                        $id = $_GET['pid'];
                                        $getpro= mysqli_query($conn,"SELECT * FROM super WHERE id= '$id' ");
                                ...
                                <form class="updadm">
                                    ...
                                    <div class="form-group mb-4">
                                        <!-- <label for="exampleFormControlInput1">Quantity</label> -->
                                        <input name="email" type="email" class="form-control-rounded form-control" id="exampleFormControlInput1" placeholder="Email" value="<?php echo $email;?>">
                                    ...
                                    <div class="form-group mb-4">
                                        <!-- <label for="exampleFormControlInput1">Quantity</label> -->
                                        <input name="password" type="text" class="form-control-rounded form-control" id="exampleFormControlInput1" placeholder="password" value="<?php echo $password;?>">
                                    ...
                                    <input type="submit" name="subc" class="mt-4 mb-4 btn btn-button-7 btn-rounded sub" value="Update Admin" style="margin-left:150px;background-color:green !important;">
