...
<html lang="en"><head>
    ...
    <style type="text/css">
        #results { padding:10px;margin-left:-20px;border-radius:10px; border:1px solid; background:#ccc; }
        ...
        <div id="content" class="main-content">
            <div class="container">
                ...
                <div class="row layout-spacing">
                    ...
                    <div class="col-lg-10 col-lg-10 col-md-10 col-sm-10 col-10 layout-spacing"   style="margin: auto;">
                        <div class="statbox widget box box-shadow">
                            <div class="widget-header">                                
                                <div class="row">
                                    <div class="col-xl-12 col-md-12 col-sm-12 col-12">
                                       <center> <u><h4>Add Members</h4></u></center>
                                    </div>                                                      
                                </div>
                            </div>
                            <div class="widget-content widget-content-area">
                                <form class="adcust" id="admember">
                                   
                                    <div class="form-group mb-4">
                                        <!-- <label for="exampleFormControlInput1">Quantity</label> -->
                                        <input name="name" type="text" class="form-control-rounded form-control" id="exampleFormControlInput1" placeholder="Member's  Name">
                                    </div>


                                    <div class="form-group mb-4">
                                        <!-- <label for="exampleFormControlInput1">Quantity</label> -->
                                        <input name="nickname" type="text" class="form-control-rounded form-control" id="exampleFormControlInput1" placeholder="NickName">
                                    </div>

                                    <div class="form-group mb-4">
                                        <!-- <label for="exampleFormControlInput1">Quantity</label> -->
                                        <input name="position" type="text" class="form-control-rounded form-control" id="exampleFormControlInput1" placeholder="Position">
                                    </div>
                                    ...
                                    <div class="form-group mb-4">
                                        <!-- <label for="exampleFormControlInput1">Quantity</label> -->
                                        <input name="contact" type="number" class="form-control-rounded form-control" id="exampleFormControlInput1" placeholder="Phone Number ">
                                    </div>


                                    <div class="form-group mb-4">
                                        <!-- <label for="exampleFormControlInput1">Quantity</label> -->
                                        <input name="club" type="text" class="form-control-rounded form-control" id="exampleFormControlInput1" placeholder="Club/Society">
                                    </div>

                                    <div class="form-group mb-4">
                                        <!-- <label for="exampleFormControlInput1">Quantity</label> -->
                                        <textarea name="ambition"  class="form-control-rounded form-control" id="exampleFormControlInput1" placeholder="Ambition"></textarea>
                                    </div>
                                    ...
                                    <input type="submit" name="" class="mt-4 mb-4 btn btn-button-7 btn-rounded sub" value="Add member" style="margin-left:150px;background-color:green !important;">
